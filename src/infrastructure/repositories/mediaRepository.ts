...
export const mediaRepository = (client: Http): MediaRepository => ({
    getMediaById: async id => {
        ...
        return {
            ...
            backgroundImage: `${
                import.meta.env.VITE_EMBY_SERVER_API_URL
            }/emby/Items/${id}/Images/Backdrop?api_key=020eed90ed7e4b3f95d73dc3ed8f11b6`,
            videoUrl: `${
                import.meta.env.VITE_EMBY_SERVER_API_URL
            }Videos/${id}/stream?static=true&allowVideoStreamCopy=true&api_key=020eed90ed7e4b3f95d73dc3ed8f11b6`
        };
    },
    ...
    getMediaByTitle: async title => {
        ...
        return {
            ...
            thumb: `${import.meta.env.VITE_EMBY_SERVER_API_URL}/emby/Items/${
                Items[0]
            }/Images/Thumb?api_key=020eed90ed7e4b3f95d73dc3ed8f11b6`,
            ...
            backgroundImage: `${import.meta.env.VITE_EMBY_SERVER_API_URL}/emby/Items/${
                Items[0].Id
            }/Images/Backdrop?api_key=020eed90ed7e4b3f95d73dc3ed8f11b6`,
            videoUrl: `${import.meta.env.VITE_EMBY_SERVER_API_URL}/Videos/${
                Items[0].Id
            }/stream?static=true&allowVideoStreamCopy=true&api_key=020eed90ed7e4b3f95d73dc3ed8f11b6`
        };
    }
});
